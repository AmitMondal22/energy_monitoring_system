...
def energy_data(energy_data):
    try:
        ...
        select="ed.energy_data_id, ed.device_id, ed.device, ed.do_channel, ed.e1, ed.e2, ed.e3, ed.r, ed.y, ed.b, ed.r_y, ed.y_b, ed.b_y, ed.curr1, ed.curr2, ed.curr3, ed.activep1, ed.activep2, ed.activep3, ed.apparentp1, ed.apparentp2, ed.apparentp3, ed.pf1, ed.pf2, ed.pf3, ed.freq, ed.reactvp1, ed.reactvp2, ed.reactvp3, ed.avaragevln, ed.avaragevll, ed.avaragecurrent, ed.totkw, ed.totkva, ed.totkvar, ed.runhr, ed.date, ed.time , DATE_FORMAT(ed.created_at, '%Y-%m-%d %H:%i:%s') AS created_at,md.device,md.device_type, md.meter_type md.device_name"
